...
const AdminHome = () => {
    ...
    const { data: stats = {} } = useQuery({
        ...
        queryFn: async () => {
            const res = await axiosSource.get('/admin-stats')
            return res.data
        }
    })
    ...
    const { data: chartData = [] } = useQuery({
        ...
        queryFn: async () => {
            const res = await axiosSource.get('/order-stats')
            return res.data
        }
    })
    ...
    return (
        <div>
            <div className="mt-5">
                <SectionTitle subtitle='Admin Home' headerTitle='Hi, welcome back'></SectionTitle>
            </div>


            <div className="stats shadow text-center flex  justify-center">

                <div className="stat">
                    <div className="stat-figure text-3xl text-pink-600">
                        <FaMoneyCheckAlt></FaMoneyCheckAlt>
                    </div>
                    <div className="text-lg">Revenues</div>
